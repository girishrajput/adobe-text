        ...
        <div class="product__footer">
          ...
          <div class="bottom">
            <div class="btn__group">
              <button class="btn addToCart" data-id= ${item.id} ><i class="fa fa-cart-plus"></i>
Add to Cart</button>
            </div>
            <div>
			 <div class="price-offer">$ ${item.price.actual}</div>
			 <div class="price-product">$ ${item.price.display}</div>
			 <div class="price-off">$ ${item.discount} % Off</div>
			 </div>
          </div>
        </div>
      </div>
    ...
    addCartItem(item) {
        ...
        div.innerHTML = `<img src=${item.image}>
          ...
          <div>
            ...
            <span class="remove__item" data-id=${item.id}>
              <svg>
